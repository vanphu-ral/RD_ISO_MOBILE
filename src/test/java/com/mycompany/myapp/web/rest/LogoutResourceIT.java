...
class LogoutResourceIT {
    ...
    public void before() throws Exception {
        ...
        SecurityContextHolder.getContext()
                .setAuthentication(registerAuthenticationToken(authorizedClientService, clientRegistration,
    ...
    void getLogoutInformation() throws Exception {
        final String ORIGIN_URL = "http://localhost:1234";
        ...
        restLogoutMockMvc
                .perform(post("http://localhost:1234/api/logout").header(HttpHeaders.ORIGIN, ORIGIN_URL))
